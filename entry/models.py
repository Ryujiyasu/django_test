...
class Entry(models.Model):
    ...
    entry_place = models.ForeignKey(
        MstPlace, verbose_name="入室場所", on_delete=models.CASCADE, related_name="entry_place"
    )
    exit_date = models.DateTimeField('退室日時', null=True, blank=True)
    exit_place = models.ForeignKey(
        MstPlace, verbose_name="退室場所", on_delete=models.CASCADE, related_name="exit_place", null=True, blank=True
    )
